...
class Version20141228132601 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE place_categories (place_id INT NOT NULL, placecategory_id INT NOT NULL, INDEX IDX_1433D060DA6A219 (place_id), INDEX IDX_1433D0605FCDFB92 (placecategory_id), PRIMARY KEY(place_id, placecategory_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE place_category (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
